...
- (id)initWithURL:(NSURL*)url internal:(BOOL)internal {
    ...
    if (_image == nil)
        //_image = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"password" ofType:@"png"]];
...
- (TokenCode*)code {
    ...
    TokenCode *token = [[TokenCode alloc] initWithCode:getHOTP(algo, _digits, key, now / period)
